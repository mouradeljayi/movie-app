...
<html lang="en" dir="ltr">
  ...
  <body class="font-sans bg-gray-900 text-white">
    ...
    <div class="border-b border-gray-800 py-8 flex flex-col text-sm md:text-base items-center">
      All Rights Reserved &copy; | Created by Mourad EL Jayi using TMDB API
    </div>
